  ...
  getPublicServiceSubOptions(publicService) {
    this.httpService.post('canales', 'publicservice/publicserviceenterpriselistbycategory',{
      ...
      .subscribe(resp => {
        ...
        let subtions = []
        list.forEach(elem=>{
          subtions = [...subtions, {name: elem.publicServiceEnterpriseDescription ,routerLink:'', publicServiceEnterpriseCode: elem.publicServiceEnterpriseCode,publicServiceEnterpriseId: elem.publicServiceEnterpriseId}]
        })
